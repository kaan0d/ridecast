...
- Now 47 tests: stage 8 adds the clothing table (nothing on a calm day, items and reasons, wet road asks for rain gear, merged duplicates, vehicles) and the worst-condition summary.
