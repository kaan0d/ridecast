...
- Now 50 tests: stage 8 adds the clothing table (nothing on a calm day, items and reasons, wet road asks for rain gear, merged duplicates, vehicles) and the worst-condition summary, OSM tag classification of stops, thinning and shelter filtering, and the route bounding boxes.
