...
- Now 39 tests: stage 6 adds route score weighting by distance share, missing forecasts, the safest-route choice with its time and risk difference, the minimum drop, ties and the no-risk case.
