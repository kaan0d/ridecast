...
export const VEHICLES: Record<VehicleType, VehicleDefaults> = {
  motorcycle: { avgKmh: 80, roadKmh: { motorway: 110, primary: 80, urban: 40 } },
  car: { avgKmh: 85, roadKmh: { motorway: 120, primary: 90, urban: 45 } },
  bicycle: { avgKmh: 18, roadKmh: { motorway: 22, primary: 20, urban: 15 } },
  walking: { avgKmh: 5, roadKmh: { motorway: 5, primary: 5, urban: 4.5 } },
};
